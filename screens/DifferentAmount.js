    ...
    return(
        <View style={{flex:1,backgroundColor:'#f2f2f2'}}>
            ...
            <View style={{height:160,width:'90%',marginLeft:17,marginTop:40,borderRadius:1,borderStyle:'dashed',borderWidth:1,borderWidthColor:'#c0c0c0'}}>
                ...
                <View style={{flexDirection:'row'}}>
                 <TextInput placeholder="Enter Duration" value={duration}  
              ...
              <TouchableOpacity style={{marginTop:10}} onPress={()=>alert("Loan request has been sent")} >
                        <View style={{ padding: 10,backgroundColor:'blue',marginLeft:35,marginHorizontal:5,shadowColor: '#000', shadowOffset: { width: 0, height: 2,},shadowOpacity: 0.25, shadowRadius: 3.84,elevation: 5,borderWidth:1,borderColor:'blue',width:115,marginBottom:6}}>
